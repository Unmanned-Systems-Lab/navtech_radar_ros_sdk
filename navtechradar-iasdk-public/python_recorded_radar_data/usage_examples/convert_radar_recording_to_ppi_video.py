...
# Save the radar data to a ppi video
# this will create a huge file, so scale the resultion to 1000 pixels
recorded_data_reader.ConvertRecordingToPpiVideo(scale_to = 1000)