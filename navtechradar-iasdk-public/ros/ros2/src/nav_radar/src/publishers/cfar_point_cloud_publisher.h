...
class Cfar_point_cloud_publisher : public ::rclcpp::Node
{
public:
...
private:
    ...
    int threshold_delta{ 0 };
    int num_train_cells{ 0 };
    int num_guard_cells{ 0 };
    int window_size{ 0 };
    ...
    rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr cfar_point_cloud_publisher{};
};