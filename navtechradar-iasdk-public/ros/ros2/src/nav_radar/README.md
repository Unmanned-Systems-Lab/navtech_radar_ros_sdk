...
| bins_to_operate_on    | int        | <number_of_bins> | The number of bins to run the peak finding algorithm on. | ros2 param set navigation_mode_point_cloud_publisher start_bin 500|
