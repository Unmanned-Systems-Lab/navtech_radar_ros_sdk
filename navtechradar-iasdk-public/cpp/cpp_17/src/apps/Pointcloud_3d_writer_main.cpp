...
int main(int argc, char* argv[])
{
    ...
    auto udp_addr = options.global_option("-u").translate_to<IP_address>();   
    auto udp_port = options.global_option("-d").to_int<std::uint16_t>();
    auto filetag = options.global_option("-f").value();
    Network_mode mode { options.global_option("-m").to_int<std::uint16_t>() };
