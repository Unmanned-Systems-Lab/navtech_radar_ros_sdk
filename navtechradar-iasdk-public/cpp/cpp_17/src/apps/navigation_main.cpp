...
void process_FFT_data(Client& radar_client [[maybe_unused]], Message& msg)
{
...
//
void process_configuration(Client& radar_client, Message& msg)
{
    ...
    auto cfg_msg = msg.view_as<Colossus_protocol::TCP::Configuration>();
    auto protobuf = from_vector_into<Colossus::Protobuf::ConfigurationData>(cfg_msg->to_vector());
    ...
    //
    radar_client.set_handler(TCP::Type::fft_data, process_FFT_data);
...
try
{
    ...
    radar_client.set_handler(TCP::Type::configuration, process_configuration);
