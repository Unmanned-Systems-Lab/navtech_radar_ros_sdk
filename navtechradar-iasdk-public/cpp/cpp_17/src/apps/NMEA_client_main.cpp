...
using Navtech::Networking::NMEA_protocol::Client;
using Navtech::Networking::NMEA_protocol::Message;
using Navtech::Networking::NMEA_protocol::Type;
...
try
{
    ...
    auto addr = options.global_option("-i").translate_to<IP_address>();
    auto port = options.global_option("-p").to_int<std::uint16_t>();
