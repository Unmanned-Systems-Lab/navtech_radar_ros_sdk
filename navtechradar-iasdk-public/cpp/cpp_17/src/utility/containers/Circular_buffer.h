...
namespace Navtech::Utility {
    ...
    public:
        void push(T&& in_val);
        void push(const T& in_val);
        template <template <typename... U> class Container_Ty, typename... V> void push(const Container_Ty<T, V...>& in_vals);
        template <template <typename... U> class Container_Ty, typename... V> void push(Container_Ty<T, V...>&& in_vals);
    ...
    template <typename T, std::size_t sz>
    template <template <typename... U> class Container_Ty, typename... V>
    void Circular_buffer<T, sz>::push(const Container_Ty<T, V...>& in_vals)
    {
    ...
    template <typename T, std::size_t sz>
    template <template <typename... U> class Container_Ty, typename... V>
    void Circular_buffer<T, sz>::push(Container_Ty<T, V...>&& in_vals)
    {
        using std::move;
