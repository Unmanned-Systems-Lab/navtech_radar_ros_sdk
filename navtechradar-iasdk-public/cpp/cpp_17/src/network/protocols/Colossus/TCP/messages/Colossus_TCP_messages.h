...
#pragma pack(1)
    ...
    class Change_profile : public Message_base::Header_only<Change_profile> {
    public:
        void            register_0(std::uint32_t val)   { register_0_val = to_uint32_network(val); }
        std::uint32_t   register_0() const              { return to_uint32_host(register_0_val); }

        void            register_1(std::uint32_t val)   { register_1_val = to_uint32_network(val); }
        std::uint32_t   register_1() const              { return to_uint32_host(register_1_val); }

        void            register_2(std::uint32_t val)   { register_2_val = to_uint32_network(val); }
        std::uint32_t   register_2() const              { return to_uint32_host(register_2_val); }

        void            register_3(std::uint32_t val)   { register_3_val = to_uint32_network(val); }
        std::uint32_t   register_3() const              { return to_uint32_host(register_3_val); }

        void            register_4U(std::uint32_t val)  { register_4U_val = to_uint32_network(val); }
        std::uint32_t   register_4U() const             { return to_uint32_host(register_4U_val); }

        void            register_4D(std::uint32_t val)  { register_4D_val = to_uint32_network(val); }
        std::uint32_t   register_4D() const             { return to_uint32_host(register_4D_val); }

        void            register_5U(std::uint32_t val)  { register_5U_val = to_uint32_network(val); }
        std::uint32_t   register_5U() const             { return to_uint32_host(register_5U_val); }

        void            register_5D(std::uint32_t val)  { register_5D_val = to_uint32_network(val); }
        std::uint32_t   register_5D() const             { return to_uint32_host(register_5D_val); }

        void            register_6U(std::uint32_t val)  { register_6U_val = to_uint32_network(val); }
        std::uint32_t   register_6U() const             { return to_uint32_host(register_6U_val); }

        void            register_6D(std::uint32_t val)  { register_6D_val = to_uint32_network(val); }
        std::uint32_t   register_6D() const             { return to_uint32_host(register_6D_val); }

        void            register_7(std::uint32_t val)   { register_7_val = to_uint32_network(val); }
        std::uint32_t   register_7() const              { return to_uint32_host(register_7_val); }

        std::size_t     size() const                    { return (sizeof(std::uint32_t) * 11); }
        
    private:
        std::uint32_t   register_0_val;
        std::uint32_t   register_1_val;
        std::uint32_t   register_2_val;
        std::uint32_t   register_3_val;
        std::uint32_t   register_4U_val;
        std::uint32_t   register_4D_val;
        std::uint32_t   register_5U_val;
        std::uint32_t   register_5D_val;
        std::uint32_t   register_6U_val;
        std::uint32_t   register_6D_val;
        std::uint32_t   register_7_val;
    };
