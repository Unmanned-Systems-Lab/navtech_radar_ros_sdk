...
namespace Navtech::Networking {
    ...
    public:
        ...
        // Functions
        //
        static void set_socket_options(Socket& socket [[maybe_unused]])
        {
            // TODO - 
        }
    };
    ...
    //
    template <>
    class Connection_traits<Protocol::colossus, Transport::file, TLS::Type::none> {
    public:
        // Types
        //
        using Stream            = std::ifstream; // TODO is this correct, at all?
        using Message_buffer    = std::vector<std::uint8_t>;
