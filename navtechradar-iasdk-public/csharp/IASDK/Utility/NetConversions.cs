...
namespace Navtech.IASDK.Utility
{
    ...
    public static class NetConversions
    {
        ...
        /// <summary>
        /// Swaps bytes in a single-precision float
        /// </summary>
        /// <param name="value">float to manipulate</param>
        /// <returns>Corrected float value</returns>
        public static float SwapSingle(float value)
        {
            return BitConverter.ToSingle(BitConverter.GetBytes(SwapUInt32(BitConverter.ToUInt32(BitConverter.GetBytes(value)))));
        }
    }
}
