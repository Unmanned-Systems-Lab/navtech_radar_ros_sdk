...
namespace Navtech.IASDK.Networking.Messages
{
    ...
    public struct TcpConfigurationDataMessage : IRawData
    {
        ...
        /// Typically 400
        /// </summary>
        public ushort AzimuthSamples => NetConversions.SwapUInt16(_azimuthSamples);

        /// <summary>
        /// The resolution size of each bin (in range)
        /// This is provided in millimetres
        /// </summary>
        public ushort BinSize => NetConversions.SwapUInt16(_binSize);

        /// <summary>
        /// Total number of bins for each sample
        /// </summary>
        public ushort RangeInBins => NetConversions.SwapUInt16(_rangeInBins);

        /// <summary>
        /// The size of the encoder wheel in the radar
        /// This can be used to convert the azimuth reading into degrees
        /// Typically encoder wheel is 5600
        /// </summary>
        public ushort EncoderSize => NetConversions.SwapUInt16(_encoderSize);

        /// <summary>
        /// The rotation speed of the radar
        /// This is provided in milli-Hertz
        /// </summary>
        public ushort RotationSpeed => NetConversions.SwapUInt16(_rotationSpeed);

        /// <summary>
        /// The expected number of packets per second being sent
        /// across the network from the radar
        /// </summary>
        public ushort PacketRate => NetConversions.SwapUInt16(_packetRate);

        /// <summary>
        /// The current range gain setting
        /// </summary>
        public float RangeGain => BitConverter.ToSingle(BitConverter.GetBytes(NetConversions.SwapUInt32(_rangeGain)), 0);

        /// <summary>
        /// The current range offset setting
        /// </summary>
        public float RangeOffset => BitConverter.ToSingle(BitConverter.GetBytes(NetConversions.SwapUInt32(_rangeOffset)), 0);
