...
namespace Navtech.IASDK.Networking.Messages
{
    ...
    public struct TcpFftDataMessage : IRawData
    {
        ...
        /// </summary>
        public ushort FftDataOffset => NetConversions.SwapUInt16(_fftDataOffset);
        /// <summary>
        /// An incremental counter that is incremented by 1 for each azimuth processed
        /// </summary>
        public ushort SweepCounter => NetConversions.SwapUInt16(_sweepCounter);
        /// <summary>
        ...
        {
            _fftDataOffset = NetConversions.SwapUInt16((ushort)Size);
            _sweepCounter = NetConversions.SwapUInt16(sweepCounter);
