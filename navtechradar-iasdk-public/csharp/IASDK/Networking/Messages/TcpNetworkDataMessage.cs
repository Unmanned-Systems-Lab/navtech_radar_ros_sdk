...
namespace Navtech.IASDK.Networking.Messages
{
    ...
    public class TcpNetworkDataMessage : IRawData
    {
        ...
        public TcpNetworkDataMessage(byte[] data)
        {
            ...
            PayloadSize = NetConversions.SwapInt32(BitConverter.ToInt32(data.Slice(index, index + PayloadLength), 0));
            index += PayloadLength;
        ...
        private byte[] HeaderBytes()
        {
            ...
            var payloadLength = BitConverter.GetBytes(NetConversions.SwapInt32(PayloadSize));
